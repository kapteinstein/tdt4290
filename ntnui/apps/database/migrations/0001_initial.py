# Generated by Django 2.1 on 2018-08-27 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='database.GroupMediaModel')),
            ],
            options={
                'verbose_name': 'Group',
        ...
        migrations.AddField(
            model_name='groupmodel',
            name='meta',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='database.GroupMetaModel'),
        ),
        migrations.AddField(
            model_name='groupmodel',
            name='sub_group',
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.GroupModel'),
        ),
        migrations.AddField(
