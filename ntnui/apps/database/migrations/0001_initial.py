# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-08-25 19:06
from __future__ import unicode_literals

import database.models.group_media
import database.models.membership
import database.models.user_manager
import datetime
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', database.models.user_manager.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='BoardModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.CharField(choices=[('O', 'Open/Public'), ('C', 'Closed/Restricted')], default='O', max_length=20)),
                ('group_media', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.GroupMediaModel')),
                ('group_meta', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.GroupMetaModel')),
            ],
            options={
                'verbose_name': 'Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateField(default=datetime.date.today)),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role', to='database.BoardModel')),
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='database.GroupModel'),
        ),
        migrations.AddField(
